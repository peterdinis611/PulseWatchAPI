...
@InputType()
export class CreateStressTestInput {
  @Field()
  @Trim()
  @IsString()
  ...
  @Field(() => Int, { nullable: true, defaultValue: DEFAULT_STRESS_TEST_VUS })
  @IsOptional()
  @IsInt()
  @Min(MIN_VUS)
  @Max(MAX_VUS)
  ...
  @Field(() => Int, {
    nullable: true,
    defaultValue: DEFAULT_STRESS_TEST_DURATION_SEC,
  })
  @IsOptional()
  @IsInt()
  ...
  @Field(() => Int, { nullable: true, defaultValue: DEFAULT_EXPECTED_STATUS })
  @IsOptional()
  @IsInt()
  @Min(100)
  @Max(599)
